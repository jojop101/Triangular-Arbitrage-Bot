...
def calc_tri_arb_surface_rate(t_pair , prices_dict):
    starting_amount = 100
    min_surface_rate = 0
    surface_dict = {}
    contract_2 = ""
...
# check spelling of quote if a error occurs in this piece
    ...
    for direction in direction_list:
        ...
        #trade description
        trade_description_1 = f"Start with {swap_1} of {starting_amount}. Swap at {swap_1_rate} for {swap_2} for acquring {acquired_coin_t1}"
